...
<form on:submit|preventDefault={handleSubmit} class="max-w-2xl mx-auto bg-white shadow-md rounded-lg p-6 space-y-6">
    <h2 class="text-2xl font-bold text-sky-700">Editar Ticket</h2>
    ...
    <div>
        ...
        <input type="text" id="clientId" bind:value={clientId} class="mt-1 block w-full rounded-md border-sky-300 shadow-sm focus:ring-sky-500 focus:border-sky-500 sm:text-sm" />
    </div>
