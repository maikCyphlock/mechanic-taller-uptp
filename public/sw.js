// <define:process.env.settings>
var define_process_env_settings_default = { strategy: "NetworkFirst", cacheAssets: "static-assets", disableDevLogs: true };
...
// src/pwa/sw.js
var SETTINGS = define_process_env_settings_default;
var STRATEGY = SETTINGS.strategy;
var CACHE_ASSETS = SETTINGS.cacheAssets;
var DISABLE_DEV_LOGS = SETTINGS.disableDevLogs;
var { scripts } = SETTINGS;
var { notification } = SETTINGS;
var { saveSubscriptionPath } = SETTINGS;
var { applicationServerKey } = SETTINGS;
...
var saveSubscription = async (subscription) => {
...
var getNotification = async (event) => {
  console.log("notify");
...
var staticAssetsRoute = new Route(
  ({ request }) => ["image", "script", "style"].includes(request.destination) || request.origin === "https://fonts.googleapis.com",
  returnStrategy()
);
registerRoute(staticAssetsRoute);
var googleFontsRoute = new Route(
